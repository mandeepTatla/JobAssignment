    ...
    public partial class SettingController : BaseAdminController
    {
        ...
        public virtual async Task<IActionResult> News(NewsSettingsModel model)
        {
            ...
            { 
                ...
                await _settingService.SaveSettingOverridablePerStoreAsync(newsSettings, x => x.AutomaticallyApproveNewComment, model.AutomaticallyApproveNewComment_OverrideForStore, storeScope, false);
