...
namespace Nop.Web.Areas.Admin.Models.Settings
{
    ...
    /// </summary>
    public partial record NewsSettingsModel : BaseNopModel, ISettingsModel
    {
        #region Properties
        ...
        [NopResourceDisplayName("Admin.Configuration.Settings.News.AutomaticallyApproveNewComment")]
        public bool AutomaticallyApproveNewComment { get; set; }
        public bool AutomaticallyApproveNewComment_OverrideForStore { get; set; }
